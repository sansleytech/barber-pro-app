...
class FuentePago(Base):
    ...
    franquicia = Column(String(30), nullable=True)
    exp_mes = Column(String(2), nullable=True)
    exp_anio = Column(String(4), nullable=True)
    aviso_vencimiento_enviado = Column(Boolean, default=False)  # VISA, MASTERCARD, etc.
