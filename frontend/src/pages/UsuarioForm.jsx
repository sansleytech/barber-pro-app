  ...
  const enviar = async (e) => {
    ...
    try {
      if (editando) {
        ...
        if (form.pregunta_seguridad)
          datos.pregunta_seguridad = form.pregunta_seguridad;
        if (form.respuesta_seguridad)
          datos.respuesta_seguridad = form.respuesta_seguridad;
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-gray-400 mb-6">
        {editando
          ? "Modificá el acceso del usuario"
          : "Creá un acceso al sistema"}
      </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("nombre_usuario", e.target.value.toLowerCase().trim())
              }
              className={
                inputClase + (editando ? " opacity-60 cursor-not-allowed" : "")
              }
