...
function ServicioForm() {
    ...
    const inputClase = "w-full bg-ink border border-line rounded-lg px-4 py-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-gold transition-colors";
    ...
    return (
        <div className="w-full">
            ...
            <p className="text-gray-400 mb-6">
                {editando ? "Modificá los datos del servicio" : "Completá los datos del servicio"}
            </p>
            ...
            <form onSubmit={enviar} className="bg-ink-card border border-line rounded-2xl p-6 md:p-8 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label className="block text-sm text-gray-300 mb-1.5">Nombre del servicio *</label>
                        <input
                            type="text"
                            value={form.nombre}
                    ...
                    <div>
                        <label className="block text-sm text-gray-300 mb-1.5">Precio *</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            value={form.precio}
                    ...
                    <div>
                        <label className="block text-sm text-gray-300 mb-1.5">Duración (minutos) *</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            value={form.duracion_minutos}
                            onChange={(e) => cambiar("duracion_minutos", soloNumeros(e.target.value))}
                            className={inputClase}
