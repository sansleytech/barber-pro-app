...
function ClienteForm() {
  ...
  const soloLetras = (valor) =>
    valor.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]/g, "").toUpperCase();
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("documento", soloNumeros(e.target.value))
              }
              className={inputClase}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("primer_nombre", soloLetras(e.target.value))
              }
              className={inputClase}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("segundo_nombre", soloLetras(e.target.value))
              }
              className={inputClase}
