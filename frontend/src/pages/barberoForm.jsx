...
const BarberoForm = () => {
    ...
    const soloLetras = (v) => v.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]/g, "").toUpperCase();
    ...
    return (
        <div className="w-full">
            ...
            <p className="text-gray-400 mb-6">
                {editando ? "Modificá los datos del barbero" : "Completá los datos del barbero"}
            </p>
            ...
            <form onSubmit={enviar} className="bg-ink-card border border-line rounded-2xl p-6 md:p-8 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label className="block text-sm text-gray-300 mb-1.5">Especialidad</label>
                        <input
                            type="text"
                            value={form.especialidad}
                            onChange={(e) => cambiar("especialidad", aMayuscula(e.target.value))}
                            className={inputClase}
                    ...
                    <div>
                        <label className="block text-sm text-gray-300 mb-1.5">Fecha de ingreso *</label>
                        <input
                            type="date"
