        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("costo_actual", soloNumeros(e.target.value))
              }
              className={inputClase}
              placeholder="0"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("precio_venta", soloNumeros(e.target.value))
              }
              className={inputClase}
              placeholder="0"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("stock_actual", soloNumeros(e.target.value))
              }
              className={inputClase}
              placeholder="0"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("stock_minimo", soloNumeros(e.target.value))
              }
              className={inputClase}
              placeholder="5"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                cambiar("stock_maximo", soloNumeros(e.target.value))
              }
              className={inputClase}
              placeholder="50"
            />
