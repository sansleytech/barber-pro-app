    ...
    <div>
      ...
      <div className="bg-ink-card border border-line rounded-2xl p-4 mb-6 flex flex-col lg:flex-row lg:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 lg:ml-auto">
          <span className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium ${
            cerrada ? "bg-gray-500/10 text-gray-400" : "bg-emerald-500/10 text-emerald-400"
          }`}>
